...
#define CFE_PSP_WATCHDOG_MAX (0x0000FFFF) 
...
** Note: This fixes a cFE/OSAL problem. 
**       The cFE Time subsystem calls OS_SetLocalMET and OS_GetLocalMET, but the OSAL
**       does not implement these calls. For MMS, they were implemented in the cdh_lib subsystem, but
**       the cFE does not include the cdh_lib headers. By putting the prototypes here, we can
**       avoid modifying the cFE and OSAL. 
**       This will be fixed in a future cFE release.
*/
...
/*
** 1Hz interrupt rountines
*/

void CFE_PSP_Setup1HzInterrupt(void);
